// File-system tree composable with auto-refresh every 3 seconds.
// FileTree renders the root; DirectoryNode recurses into subdirectories.
// Row-level rendering (icons, hover, context menu) lives in FileTreeRow.kt.
